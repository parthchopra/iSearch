...
builder.Services.AddHttpClient<ITunesSearchService, TunesSearchService>();
builder.Services.AddScoped<ICollectionRepository, CollectionRepository>();
builder.Services.AddDbContext<CollectionDbContext>(options =>
{
    options.UseSqlServer(builder.Configuration["ConnectionStrings:collectionDbContextConnection"]);
});
